...
class TestGetProjectsOfEmployer(TestCase):
    def test_get(self):
        """Get projects of an employer without any error or problem by API"""
        app = create_app()
        with app.app_context():
            ...
            result = client.get('http://127.0.0.1:5000/api/get_projects_of_employer',
                                headers=headers)
