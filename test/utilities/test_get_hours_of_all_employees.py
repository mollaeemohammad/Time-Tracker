...
class TestGetHoursOfAllEmployees(TestCase):
    def test_get_all_hours(self):
        """Properly getting all hours of all employees worked on the project"""
        ...
        insert_hours('employee2', 'test', 10.0)
        self.assertEqual(len(get_hours_of_all_employees('test')), 2)
        delete_project('test')
